...
# x86_64
curl -T "$BUILD_BINARIESDIRECTORY/pkg/fedora/25/qbittorrent-cli-${PkgFullVersion}.x86_64.rpm" "-ufedarovich:$1" "https://api.bintray.com/content/fedarovich/qbittorrent-cli-rh/qbittorrent-cli/${PkgFullVersion}/qbittorrent-cli-${PkgFullVersion}.x86_64.rpm?publish=1"

# armv7hl
curl -T "$BUILD_BINARIESDIRECTORY/pkg/fedora/25/qbittorrent-cli-${PkgFullVersion}.armv7hl.rpm" "-ufedarovich:$1" "https://api.bintray.com/content/fedarovich/qbittorrent-cli-rh/qbittorrent-cli/${PkgFullVersion}/qbittorrent-cli-${PkgFullVersion}.armv7hl.rpm?publish=1"
