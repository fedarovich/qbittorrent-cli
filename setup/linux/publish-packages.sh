...
curl -T "$BUILD_BINARIESDIRECTORY/pkg/ubuntu/focal/qbittorrent-cli_${PkgFullVersion}_amd64.deb"  "-ufedarovich:$1" "https://api.bintray.com/content/fedarovich/qbittorrent-cli-debian/qbittorrent-cli/${PkgFullVersion}/focal/pool/main/q/qbittorrent-cli_${PkgFullVersion}_amd64.deb;deb_distribution=focal;deb_distribution=groovy;deb_component=main;deb_architecture=amd64?publish=1"
...
curl -T "$BUILD_BINARIESDIRECTORY/pkg/ubuntu/focal/qbittorrent-cli_${PkgFullVersion}_armhf.deb"  "-ufedarovich:$1" "https://api.bintray.com/content/fedarovich/qbittorrent-cli-debian/qbittorrent-cli/${PkgFullVersion}/focal/pool/main/q/qbittorrent-cli_${PkgFullVersion}_armhf.deb;deb_distribution=focal;deb_distribution=groovy;deb_component=main;deb_architecture=armhf?publish=1"
...
curl -T "$BUILD_BINARIESDIRECTORY/pkg/ubuntu/focal/qbittorrent-cli_${PkgFullVersion}_arm64.deb"  "-ufedarovich:$1" "https://api.bintray.com/content/fedarovich/qbittorrent-cli-debian/qbittorrent-cli/${PkgFullVersion}/focal/pool/main/q/qbittorrent-cli_${PkgFullVersion}_arm64.deb;deb_distribution=focal;deb_distribution=groovy;deb_component=main;deb_architecture=arm64?publish=1"
